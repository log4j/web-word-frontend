(function() {
    ...
    function permissionRun($rootScope, $cookies, $state, PermissionStore, RoleStore, UserService) {
        ...
        var permissions = ['viewComposite','viewEmail', 'viewGitHub', 'viewCalendar', 'viewLayouts', 'viewTodo', 'viewElements', 'viewAuthentication', 'viewCharts', 'viewMaps'];
        ...
        RoleStore.defineManyRoles({
            'SUPERADMIN': ['viewComposite','viewEmail', 'viewGitHub', 'viewCalendar', 'viewLayouts', 'viewTodo', 'viewElements', 'viewAuthentication', 'viewCharts', 'viewMaps'],
            'ADMIN': ['viewComposite','viewLayouts', 'viewTodo', 'viewElements', 'viewAuthentication', 'viewCharts', 'viewMaps'],
            'USER': ['viewComposite','viewAuthentication', 'viewCharts', 'viewMaps'],
            'ANONYMOUS': []
        });
